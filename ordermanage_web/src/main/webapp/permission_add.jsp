...
<title>新建权限</title>
<meta name="description" content="新建权限">
<meta name="keywords" content="新建权限">
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="permissionName" placeholder="权限名称">
						</div>
						<div class="col-md-2 title">权限路径</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="url" placeholder="权限路径" >
						</div>
					</div>
				</div>
				<!--订单信息/--> <!--工具栏-->
